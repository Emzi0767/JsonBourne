...
# One-click rebuild
#
# Rebuilds all Clyde.NET components with default values.
# 
# Author:       Emzi0767
...
$docs_path = ".\docs"
$docs_pkgname = "clyde-net-docs"

# --------- Execute build ---------
Set-Location ..
& .\build\rebuild-all.ps1 -ArtifactLocation "$target" -Configuration "Release" -VersionSuffix "$suffix" -BuildNumber $build_number -DocsPath "$docs_path" -DocsPackageName "$docs_pkgname" | Out-Host
